...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label.setGeometry(QtCore.QRect(11, 94, 691, 16))
        font = QtGui.QFont()
        font.setFamily("Helvetica")
        ...
        self.label_12.setGeometry(QtCore.QRect(11, 439, 691, 16))
        font = QtGui.QFont()
        font.setFamily("Helvetica")
        font.setPointSize(16)
        font.setBold(True)
    ...
    # for windows application
       ...
       # self.frame.plotWidget.axes.plot(x, s_true,'r-',label='true')
        ...
        ## this is an array 
        ## if user input is constant then set the index increment to the constant
        ##xloc = [xmin:10:xmax]
        ## xloc = [x0:10:x0+Lx]
